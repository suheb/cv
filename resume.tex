...
\vspace{5pt}
\textbf{Note: I've right to work in the UK (Exceptional Talent Tier 1 visa) and don't require sponsorship.}
%-----------EXPERIENCE-----------------
\section{Experience}
  \resumeSubHeadingListStart
   ...
   \resumeSubheading
    ...
    \resumeSubheading
      ...
      {\href{http://cltk.org/}{Mentor, \underline{Classical Language Toolkit (CLTK)}}}{April 2017 - Sept 2017}
      \resumeItemListStart
          \resumeItemNoBold
    ...
    \resumeSubheading
      ...
      {\href{http://cltk.org/}{\underline{Classical Language Toolkit (CLTK)}}}{May 2016 - Sept 2016}
      \resumeItemListStart
          \resumeItemNoBold
