  ...
  \resumeSubHeadingListStart
   ...
   \resumeSubheading
      ...
      \resumeItemListStart
          ...
          \resumeItemNoBold
          {Used \textbf{HTML5} and \textbf{CSS3} (with \textbf{styled-components}) page markup and styling.}
          \resumeItemNoBold
          {Used \textbf{TypeScript} for static type safety and built a decoder generator for run-time type safety.}
           \resumeItemNoBold
          {Worked on the deployment strategy for the web application using \textbf{Kubernetes} on AWS Cloud}
          \resumeItemNoBold
